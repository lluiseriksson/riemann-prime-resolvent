...
/-- Exact finite atomic formula `D^k b_n = Σ_i w_i p_i^n (1-p_i)^k`. -/
...
/-- A finite positive atomic measure on `[0,1]` has a completely monotone moment sequence. -/
...
/-- Pointwise nonnegativity of the finite signed differences. -/
