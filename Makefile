.PHONY: all lean figures docs static verify metadata workflow-audit hygiene docs-assets oracle-coverage generated-reproducibility manifest manifest-check audit package clean
...
audit: metadata workflow-audit hygiene docs-assets oracle-coverage manifest-check
