...
6. Formalize Galerkin, gap and alignment certificates.
7. State interval convergence in the shared-interface form.
8. Close the final composition theorem without project axioms.
