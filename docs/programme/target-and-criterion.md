...
The companion repository documents the following implication. Suppose positive Stieltjes transforms
...
This page records the consumer interface only. The canonical proof and one-point Hausdorff equivalent are maintained in `riemann-one-point-resolvent`.
